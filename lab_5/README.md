...
* Результати виконання завдання 1;
    1. Щоб увімкнути сторінки GitHub, перейшов до Settings, далі вибрав Pages. Вказав, з якої гілки буде відображатися вміст файлу, для цього вибрав гілку main, папку /root та натиснув «Зберегти».
